...
{
	syslog(LOG_INFO, "HTTP: send_snapshot()");
...
{
	syslog(LOG_INFO, "HTTP: send_stream()");
...
{
	syslog(LOG_INFO, "HTTP: send_error() - ");
...
{
	syslog(LOG_INFO, "HTTP: send_file)");
	syslog(LOG_INFO, parameter);
