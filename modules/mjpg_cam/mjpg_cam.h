...
#define		DEFAULT_INPUT_MODE	"/usr/local/lib/input_uvc.so -d /dev/video0 -r 1280x720 -f 10"
#define 	DEFAULT_OUTPUT_MODE "/usr/local/lib/output_http.so -p 8080 -w /usr/local/www"
